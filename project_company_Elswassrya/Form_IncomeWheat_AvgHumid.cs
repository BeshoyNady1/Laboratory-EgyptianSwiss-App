...
{
    public partial class Form_IncomeWheat_AvgHumid : Form
    {
        ...
        public Form_IncomeWheat_AvgHumid()
        {
            InitializeComponent();
        }
        ...
        private void Search()
        {
            try
            {
                ...
                QueryLine = "SELECT `truck_number`,`Time_IW`, COUNT(`Number_IW`) AS 'count_Units' , SUM(`Humidity`)/COUNT(`Number_IW`) AS 'Average_Humidity' FROM `incoming_wheat`WHERE `Humidity` != 0 AND `Date_IW` BETWEEN '" + dateTimePicker1.Text + "' AND '" + dateTimePicker2.Text + "'  ";
                ...
                Title_repo.Text = "(الاقماح الواردة)";
        ...
        private void Form_IncomeWheat_AvgHumid_Load(object sender, EventArgs e)
        {
        ...
        private void WhatYouSearch()
        {
            try
            {
                ...
                else
                {
                    ...
                    crypet = myReport;
                    crypet.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, @"C:\StorgePDF\Incoming_Wheat_Avrage_Humidity_Month_" + year + "_" + month + "_" + day + "_" + huar + "_" + Mint + ".Pdf");

                    Class1.Path_Report_Incoming_Wheat = @"C:\StorgePDF\Incoming_Wheat_Avrage_Humidity_Month_" + year + "_" + month + "_" + day + "_" + huar + "_" + Mint + ".Pdf";
