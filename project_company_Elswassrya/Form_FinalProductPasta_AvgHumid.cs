...
{
    public partial class Form_FinalProductPasta_AvgHumid : Form
    {
        ...
        public Form_FinalProductPasta_AvgHumid()
        {
            InitializeComponent();
        }
        ...
        private void Search()
        {
            try
            {
                ...
                QueryLine = "SELECT COUNT(`Num`) AS 'count_Units', SUM(`Humidity_Fp`) / COUNT(`Humidity_Fp`) AS 'Average_Humidity' FROM `final_product_pasta` WHERE `Humidity_Fp` != 0 AND `Date_Fp` BETWEEN '" + dateTimePicker1.Text + "' AND '" + dateTimePicker2.Text + "'  ";
        ...
        private void Form_FinalProductPasta_AvgHumid_Load(object sender, EventArgs e)
        {
        ...
        private void WhatYouSearch()
        {
            try
            {
                ...
                else
                {
                    ...
                    crypet = myReport;
                    crypet.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, @"C:\StorgePDF\FinalProductPasta_AvgHumid_" + year + "_" + month + "_" + day + "_" + huar + "_" + Mint + ".Pdf");

                    Class1.Path_Report_Incoming_Wheat = @"C:\StorgePDF\FinalProductPasta_AvgHumid_" + year + "_" + month + "_" + day + "_" + huar + "_" + Mint + ".Pdf";
