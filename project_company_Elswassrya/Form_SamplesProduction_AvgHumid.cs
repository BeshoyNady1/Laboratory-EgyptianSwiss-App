...
{
    public partial class Form_SamplesProduction_AvgHumid : Form
    {
        ...
        public Form_SamplesProduction_AvgHumid()
        {
            InitializeComponent();
        }
        ...
        private void Search()
        {
            try
            {
                ...
                QueryLine = "SELECT COUNT(`Num_SP`) AS 'count_Units' , SUM(`Moisture_SP`) / COUNT(`Moisture_SP`) AS 'Average_Humidity' FROM `samples_production` WHERE `Moisture_SP` != 0 AND `Date_SP` BETWEEN '" + dateTimePicker1.Text + "' AND '" + dateTimePicker2.Text + "'  ";
        ...
        private void Form_SamplesProduction_AvgHumid_Load(object sender, EventArgs e)
        {
        ...
        private void WhatYouSearch()
        {
            try
            {
                ...
                else
                {
                    ...
                    crypet = myReport;
                    crypet.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, @"C:\StorgePDF\SamplesProduction_AvgHumid_" + year + "_" + month + "_" + day + "_" + huar + "_" + Mint + ".Pdf");

                    Class1.Path_Report_Incoming_Wheat = @"C:\StorgePDF\SamplesProduction_AvgHumid_" + year + "_" + month + "_" + day + "_" + huar + "_" + Mint + ".Pdf";
